...
``` r
read.raxml(file = NULL, text = NULL)
```
...
- text:
  ...
  alternatively, the content of the file as a character string or a
  connection; 'file' is ignored when 'text' is given
...
#>   'bootstrap'.
#> 
#> # The associated data tibble abstraction: 3 × 4
#> # The 'node', 'label' and 'isTip' are from the phylo tree.
#>    node label isTip bootstrap
#>   <int> <chr> <lgl>     <dbl>
#> 1     1 a     TRUE         NA
