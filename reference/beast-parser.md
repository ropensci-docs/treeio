...
#>  1     1 A_1995 TRUE       0 <lgl [1]>                  NA <lgl [1]>     9.47 
#>  2     2 B_1996 TRUE       3 <lgl [1]>                  NA <lgl [1]>     6.47 
#>  3     3 C_1995 TRUE      26 <dbl [2]>                  26 <dbl [2]>     9.14 
#>  4     4 D_1987 TRUE      33 <dbl [2]>                  33 <dbl [2]>     0.616
#>  5     5 E_1996 TRUE      30 <dbl [2]>                  30 <dbl [2]>     1.60 
#>  6     6 F_1997 TRUE      21 <dbl [2]>                  21 <dbl [2]>     5.21 
#>  7     7 G_1992 TRUE      17 <dbl [2]>                  17 <dbl [2]>     3.30 
#>  8     8 H_1992 TRUE      18 <dbl [2]>                  18 <dbl [2]>     1.34 
#>  9     9 I_1994 TRUE      16 <dbl [2]>                  16 <dbl [2]>     0.849
#> 10    10 J_1983 TRUE      16 <dbl [2]>                  16 <dbl [2]>     0.849
#> # ℹ 19 more rows
...
#>  1     1 B_h   TRUE  <dbl [2]>      0.29502722… 0.2943109745… 1     100         
#>  2     2 B_s   TRUE  <dbl [2]>      0.22505344… 0.2250620826… 1     100         
#>  3     3 G_d   TRUE  <dbl [2]>      0.14346674… 0.1431799378… 1     100         
#>  4     4 G_k   TRUE  <dbl [2]>      0.19250543… 0.1922242167… 1     100         
#>  5     5 G_q   TRUE  <dbl [2]>      0.22779248… 0.2275137837… 1     100         
#>  6     6 G_s   TRUE  <dbl [2]>      0.51240506… 0.5115548762… 1     100         
#>  7     7 G_t   TRUE  <dbl [2]>      0.05472613… 0.0546279278… 1     100         
#>  8     8 M_s   TRUE  <dbl [2]>      0.01057880… 0.0103911008… 1     100         
#>  9     9 N_m   TRUE  <dbl [2]>      0.00726860… 0.0071387519… 1     100         
#> 10    10 P_h   TRUE  <dbl [2]>      0.06285712… 0.0627032472… 1     100         
#> # ℹ 12 more rows
